package edu.pku.yangliu.nlp.pdt.stem;
...
public class Porter {
  ...
  public static void main(String[] args){
	  ...
	  String testWord = "AMERICANS";
	  System.out.println("stemmed word 1: " + stemmer.stripAffixes(testWord).toUpperCase());
	  System.out.println("stemmed word 2: " + stemmer.stripSuffixes(testWord).toUpperCase());
